...
const Header = () => {
  ...
  return (
    ...
    <header className="bg-white  shadow-md">
          ...
          <div className="flex items-center justify-between">
            <div className="col1 w-[50%]">
              <p className="text-[12px] font-[500]">
                Giảm giá lên đến 50% cho các mẫu mùa mới — chỉ áp dụng trong
                thời gian có hạn.
              </p>
            </div>
      ...
      <div className="header py-2 border-t-[1px] border-gray-250 border-b-[1px]">
            ...
            <ul className="flex items-center gap-3 justify-end w-full">
              ...
              <li>
                <Tooltip title="Wishlist" placement="top">
                  <IconButton
                    aria-label="heart"
                    onClick={() => history("/my-list")}
                  >
                    <StyledBadge
                      badgeContent={context.myListCount || 0}
                      color="secondary"
                    >
                      <FaRegHeart />
                    </StyledBadge>
              ...
              <li>
                <Tooltip title="Cart" placement="top">
                  ...
                  >
                    <StyledBadge
                      badgeContent={context.cartCount || 0}
                      color="secondary"
                    >
