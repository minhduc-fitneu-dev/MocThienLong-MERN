// Pages/AdsBanner/editAdsBanner.jsx
...
const EditAdsBanner = () => {
  ...
  const banner = context?.isOpenFullScreenPanel?.data;
  ...
  const handleUpdate = async () => {
    ...
    const res = await editData(`/api/ads-banner/${banner._id}`, body);

    if (res?.success) {
      context.alertBox("success", "Ads banner updated successfully!");
      context.reloadProducts();
      context.setIsOpenFullScreenPanel({ open: false });
    } else {
      context.alertBox("error", res?.message || "Failed to update banner");
    }
  };
